...
const CoordinatorEvents: React.FC = () => {
  const navigate = useNavigate();
  const fetchUpcomingEvents = useCallback(() => eventService.getUpcomingEvents(), []);
  const { events, loading, error } = useEvents(fetchUpcomingEvents);
